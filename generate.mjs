...
export const USERNAME = process.env.GH_USERNAME || "Shoegum010";
...
${buildLegend()}
<text x="${WIDTH - 140}" y="${HEIGHT - 12}" class="hud-meta" text-anchor="end">[ARCADE DEFENSE GRID // SECTOR: SHOEGUM010]</text>
...
export async function main() {
  ...
  // Also write to dist/clone/shoegum010/github-jet.svg if path exists
  const cloneOut = path.resolve("dist/clone/shoegum010/github-jet.svg");
